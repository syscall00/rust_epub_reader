...
use druid::{AppDelegate, AppLauncher, Color, Command, Data, DelegateCtx, FontStyle, FontWeight, Handled, Lens, LocalizedString, Menu, Selector, Target, Widget, WidgetExt, WindowDesc, WindowId, commands,  Key, Vec2, ArcStr}; // FontFamily
...
/*
        ...
        AppLauncher::with_window(window)
            .log_to_console()
            .launch(AppState {
                app_name: "Rust Epub Reader.".to_string(),
...
fn page_ui() -> impl Widget<PageItem> {
    ...
    Flex::row().with_flex_child(epub_page::EpubPage::new()
...
/*
fn build_r() -> impl Widget<AppState> {
    my_widget::TextBoxx::new().with_text_color(Color::BLACK)//.lens(AppState::file_opened)
}*/
